        ...
        <div class="row gx-0">
          <div class="col-lg-6">
            <div class="left-content-box d-flex flex-column justify-content-center h-100 px-5">
              <h6 class="text-gray text-uppercase fw-medium"><?= __("Наши преимущества");?></h6>
              <span class="text-uppercase text-corp font-gilda big-quote lh-sm d-block mb-2"><?= __("<span class='font-inter fw-semibold'>Taklog INDUSTRY</span> - <br></span>");?>
              <p class="fw-medium fs-5 text-corp font-gilda big-quote lh-sm d-block mb-2"><?= __("больше чем просто логистика");?></p>
              <p class="fw-normal text-gray font-gilda big-quote lh-sm d-block mb-2"><?= __("Мы предоставляем нашим клиентам не просто логистические услуги, а надежные и комплексные решения, которые упрощают сложные процессы и способствуют их развитию. TAKLOG строит свою работу на принципах эффективности, точности и индивидуального подхода, помогая вам достигать новых бизнес-целей.

Мы понимаем, что логистика — это не только перевозка грузов, но и ключ к успешной организации поставок. Наша команда экспертов доступна 24/7, чтобы обеспечить надежность и оперативность на каждом этапе сотрудничества. Ваши успехи — наша приоритетная задача.

Наша экспертиза охватывает ключевые регионы и направления, где мы предлагаем решения, адаптированные под ваши задачи и географические особенности:Мы предоставляем нашим клиентам не просто логистические услуги, а надежные и комплексные решения, которые упрощают сложные процессы и способствуют их развитию. TAKLOG строит свою работу на принципах эффективности, точности и индивидуального подхода, помогая вам достигать новых бизнес-целей.

Мы понимаем, что логистика — это не только перевозка грузов, но и ключ к успешной организации поставок. Наша команда экспертов доступна 24/7, чтобы обеспечить надежность и оперативность на каждом этапе сотрудничества. Ваши успехи — наша приоритетная задача.

Наша экспертиза охватывает ключевые регионы и направления, где мы предлагаем решения, адаптированные под ваши задачи и географические особенности:");?></p>
              <a class="text-decoration-none text-red small fw-medium" href="/about"><?= __("Узнать больше");?><i class="bi bi-arrow-down-right ms-4"></i></a>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="right-content-box mt-4">
                ...
                <div class="row gy-3 gx-lg-4 gx-0">
                  ...
                  <div class="col-lg-7">
                    <div class="text-white">
                      <span class="d-block text-uppercase lh-sm mb-3"><?= __("Высококачественный сервис");?></span>
                      <p class="small lh-sm mb-0"><?= __("поставляем Вам не просто высококачественный, но и разные индивидуальные решения, отвечающие вашим требованиям и пожеланиям.");?></p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="bg-white py-lg-5 p-4 box2 wow fadeInUp">
                <div class="row gy-3 gx-lg-4 gx-0">
                  ...
                  <div class="col-lg-7">
                    <div class="text-corp">
                      <span class="d-block text-uppercase lh-sm mb-3"><?= __("Профессионализм и компетентность");?></span>
                      <p class="small lh-sm mb-0"><?= __("Мы поставляем Вам не просто высококачественный, но и разные индивидуальные решения, отвечающие вашим требованиям и пожеланиям.");?></p>
                    </div>
                  </div>
                </div>
              </div>
