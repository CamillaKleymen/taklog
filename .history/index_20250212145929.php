        ...
        <div class="col-lg-6">
          <div class="left-content-box d-flex flex-column justify-content-center h-100 px-5">
            ...
            <span class="text-uppercase text-corp font-gilda big-quote lh-sm d-block mb-2"><?= __("<span class='font-inter fw-semibold'>Taklog INDUSTRY</span> - <br></span>"); ?>
              ...
              <p class="fw-normal text-gray font-gilda d-block mb-2"><?= __("Мы предоставляем нашим клиентам не просто логистические услуги, а надежные и комплексные решения, которые упрощают сложные процессы и способствуют их развитию. TAKLOG строит свою работу на принципах эффективности, точности и индивидуального подхода, помогая вам достигать новых бизнес-целей. <br>

Мы понимаем, что логистика — это не только перевозка грузов, но и ключ к успешной организации поставок. Наша команда экспертов доступна 24/7, чтобы обеспечить надежность и оперативность на каждом этапе сотрудничества. Ваши успехи — наша приоритетная задача. <br>
