        ...
        <div class="row gx-0">
          <div class="col-lg-6">
            <div class="left-content-box d-flex flex-column justify-content-center h-100">
              ...
              <span class="text-uppercase text-corp font-gilda big-quote lh-sm d-block mb-2"><?= __("<span class='font-inter fw-semibold'>Taklog INDUSTRY</span> - <brбольше чем просто логистика</span>");?>
