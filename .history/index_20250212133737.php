...
<html>
  ...
  <body>
      ...
      <div class="container-fluid px-0">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              ...
              <div class="carousel-caption text-start">
                <h1 class="text-uppercase with-arrow position-relative"><?= __("TAKLOG INDUSTRY, LLC – "); ?></h1>
                <p class="lh-sm small mb-lg-4"><?= __("ваш надежный партнер в сфере международных перевозок"); ?></p><a class="btn btn-primary rounded-1" href="/services"><?= __("Заказать услугу");?><i class="bi bi-arrow-down-right ms-4"></i></a>
              </div>
            </div>
        ...
        <div class="banner-contact-form mx-auto rounded-4 p-md-4 p-3 bg-corp text-white position-absolute start-0 end-0 wow fadeInUp">
          <form class="row gy-3" method="POST" action="/sender">
            <div class="col-lg-3">
              <div>
                <span class="text-uppercase font-gilda fs-3 mb-2 d-block"><?= __("Оставить заявку");?></span>
    ...
    <!-- Our advantages -->
    <section class="bg-smoke index-advantages">
      <div class="container-fluid px-0">
        <div class="row gx-0">
          <div class="col-lg-6">
            <div class="left-content-box d-flex flex-column justify-content-center h-100">
              <h6 class="text-gray text-uppercase fw-medium"><?= __("Наши преимущества");?></h6>
              <span class="text-uppercase text-corp font-gilda big-quote lh-sm d-block mb-2"><?= __("<span class='font-inter fw-semibold'>Taklog</span> - больше чем просто логистика</span>");?>
              <p class="lh-sm small fw-medium text-gray"><?= __("Неуклонный рост современной экономики, а также ее перманентная глобализация, являются основными факторами повышения эффективности доставки грузов, которая в свою очередь является одним из наиболее приоритетныx направлений в сокращении издержек организаций торговли и сферы услуг.");?></p>
              <a class="text-decoration-none text-red small fw-medium" href="/about"><?= __("Узнать больше");?><i class="bi bi-arrow-down-right ms-4"></i></a>
            </div>
          </div>
          <div class="col-lg-6">
