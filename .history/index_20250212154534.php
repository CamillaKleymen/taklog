...
<body>
  ...
  <section class="index-logistics bg-milk wow fadeInUp">
    <div class="container-fluid common-container">
      <span class="text-uppercase text-corp font-gilda medium-quote lh-sm d-block mb-lg-4 mb-3 subtitle"><?= __("ПОЛНЫЙ ЦИКЛ МЕЖДУНАРОДНОЙ ЛОГИСТИКИ"); ?><span class="font-inter fw-semibold">Taklog</span></span>
    </div>
