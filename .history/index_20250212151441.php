      ...
      <div class="row gx-0">
        <div class="col-lg-6">
          <div class="left-content-box d-flex flex-column justify-content-center h-100 px-5">
            <h2 class="text-dark text-uppercase fw-bold">Taklog INDUSTRY</h2>
            <h4 class="text-primary fw-semibold mb-3">больше, чем просто логистика</h4>
            <p class="fw-normal text-gray lh-lg mb-3">
              Мы предоставляем нашим клиентам не просто логистические услуги, а надежные и комплексные решения, которые упрощают сложные процессы и способствуют их развитию. TAKLOG строит свою работу на принципах эффективности, точности и индивидуального подхода, помогая вам достигать новых бизнес-целей.
            </p>
            <p class="fw-normal text-gray lh-lg mb-3">
            ...
            <p class="fw-normal text-gray lh-lg mb-3">
              Наша экспертиза охватывает ключевые регионы и направления, где мы предлагаем решения, адаптированные под ваши задачи и географические особенности.
            </p>
            <a class="text-decoration-none text-danger fw-medium small" href="/about">
              Узнать больше <i class="bi bi-arrow-down-right ms-2"></i>
            </a>
          </div>
        </div>
        <div class="col-lg-6">
