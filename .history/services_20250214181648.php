              ...
              <div class="col-lg-6">
                <div class="row gx-3">
                  ...
                  <div class="col-lg-10 col-md-11 col-10">
                    ...
                    <ul class="d-block lh-sm text-small">
                      <li><?= __("•	•	GPS-мониторинг для полного контроля за грузомции, странам СНГ и Центральной Азии"); ?></li>
                      <li><?= __("•	•	Интеграция с онлайн-платформами для отслеживания и управления перевозкамиупные регионы и зоны повышенного риска"); ?></li>
