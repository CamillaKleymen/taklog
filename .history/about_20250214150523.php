      ...
      <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="images/about/banner.png" class="d-block w-100" alt="...">
            <div class="carousel-caption text-start">
              <h1 class="text-uppercase display-6 fw-bold position-relative pe-5 "><?= __("TAKLOG INDUSTRY, LLC – "); ?></h1>
              <p class="large fs-5 fw-normal display-5 mb-lg-4"><?= __("вваш стратегический партнер в мире международных перевозок. С 15-летним опытом в сфере грузоперевозок, мы предоставляем комплексные решения, адаптированные под задачи каждого клиента. "); ?></p>
    ...
    <section class="py-sm-5 py-4 bg-milk wow fadeInUp">
      <div class="container-fluid common-container">
        <div class="row gx-xl-5 gx-lg-4 gy-3 gx-0">
          <div class="col-lg-6">
            <div>
              <h2 class="text-uppercase text-corp font-gilda lh-sm mb-lg-4 mb-3"><?= __("Будьте впереди с ");?><span class="font-inter fw-semibold">Taklog!</span></h2>
              <p class="lh-sm small text-black"><?= __("Мы специализируемся на решении сложных логистических задач, требующих нестандартных подходов. Наш опыт работы в различных регионах и отраслях позволяет нам успешно организовывать тяжелые перевозки, осуществлять промышленный переезд и управлять крупномасштабными мероприятиями.");?></p>
              <p class="lh-sm small text-black"><?= __("Taklog Logistics зарекомендовала себя как надежный партнер для бизнеса любого масштаба. Наши услуги пользуются высоким спросом как у небольших компаний, так и у крупных корпораций, представленных в рейтинге Fortune 500.");?></p>
              <p class="lh-sm small text-black"><?= __("Мы предлагаем комплексный подход к управлению цепочками поставок. Станьте нашим партнером и получите доступ к широкому спектру услуг, направленных на снижение затрат, ускорение доставки и повышение качества обслуживания.");?></p>
              <p class="lh-sm small text-black"><?= __("Наша компания распологает собственным парком в Европе.");?></p>
            </div>
          </div>
          
          <div class="col-lg-6">
            <img class="img-fluid w-100 h-100 object-fit-cover" src="images/index/about.png" alt="">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container-fluid common-container">
        <div class="banner-contact-form mx-auto rounded-4 p-md-4 p-3 bg-corp text-white">
          <div class="row gy-3">
            <div class="col-lg-3">
              <div>
                <span class="text-uppercase font-gilda fs-3 mb-2 d-block"><?= __("Связаться");?></span>
                <p class="fw-medium small lh-sm"><?= __("Оставьте ваши контактные данные и наши менеджеры свяжутся с вами в ближайшее время.");?></p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="row g-3">
        ...
        <div class="row g-sm-4 gx-0 gy-3">
          <div class="col-lg-4 col-md-6">
            <div class="px-lg-5 p-4 bg-smoke d-flex flex-column justify-content-center align-items-center text-center h-100">
              <img class="img-fluid mb-lg-4 mb-3" src="images/about/diamond.svg" alt="">
              <span class="font-gilda text-corp text-uppercase lh-sm"><?= __("ПРОЗРАЧНОСТЬ");?></span>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="px-lg-5 p-4 bg-smoke d-flex flex-column justify-content-center align-items-center text-center h-100">
              <img class="img-fluid mb-lg-4 mb-3" src="images/about/serve.svg" alt="">
              <span class="font-gilda text-corp text-uppercase lh-sm"><?= __("ЧЕСТНОСТЬ");?></span>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="px-lg-5 p-4 bg-smoke d-flex flex-column justify-content-center align-items-center text-center h-100">
