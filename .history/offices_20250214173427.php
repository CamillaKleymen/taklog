        ...
        <div class="">
          <div class="">
            ...
            <p class="lh-sm text-gray">
                <?= __("г. Ташкент, ул. Абдуллы Каххара, 56А"); ?><br/><br/>
                shakhzod@taklog.uz<br /><br />
                <a class="text-decoration-none text-dark" href="tel:+998712550508">+998 71 255 05 08</a><br /><br />
                <a class="text-decoration-none text-dark" href="tel:+998770041118">+998 77 004 11 18</a><br /><br />
                <a class="text-decoration-none text-dark" href="tel:+998770071118">+998 77 007 11 18</a><br /><br />
            </p>
          </div>
          <div class="">
            <h2><?= __("Германия"); ?></h2>
