              ...
              <div class="col-lg-4">
                <div>
                  <span class="fw-medium text-red d-block lh-sm fs-5 mb-lg-3 mb-2"><?= __("Автомобильные перевозки"); ?></span>
                    ...
                    <p class="lh-sm text-gray fs-6"><?= __("Наши клиенты получают доступ к широкой сети авиаперевозчиков и оптимизированным маршрутам, что позволяет максимально эффективно планировать логистику. Мы берём на себя оформление всей документации, таможенное сопровождение и координацию грузов в аэропортах."); ?></p>
                </div>
              </div>
            </div>
          </div>
