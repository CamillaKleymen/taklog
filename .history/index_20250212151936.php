          ...
          <div class="right-content-box mt-4">
              ...
              <div class="row gy-3 gx-lg-4 gx-0">
                ...
                <div class="col-lg-7">
                  <div class="text-white">
                    <span class="d-block fw-normal text-uppercase lh-sm mb-3"><?= __("Европа "); ?></span>
            ...
            <div class="bg-white py-lg-5 p-4 box2 wow fadeInUp">
              <div class="row gy-3 gx-lg-4 gx-0">
                ...
                <div class="col-lg-7">
                  <div class="text-corp">
                    <span class="d-block fw-normal text-uppercase lh-sm mb-3"><?= __("СНГ"); ?></span>
            ...
            <div class="bg-orange py-lg-5 p-4 box3 wow fadeInUp">
              <div class="row gy-3 gx-lg-4 gx-0">
                ...
                <div class="col-lg-7">
                  <div class="text-corp">
                    <span class="d-block fw-normal text-uppercase lh-sm mb-3"><?= __("Турция и Китай"); ?></span>
