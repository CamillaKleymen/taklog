        ...
        <div class="row g-sm-4 gx-0 gy-3">
          <div class="col-lg-4 col-md-6">
            <div class="px-lg-5 p-4 bg-smoke d-flex flex-column justify-content-center align-items-center text-center h-100">
              ...
              <span class="font-gilda text-corp text-uppercase lh-sm"><?= __("Открытость и доверие");?></span>
              <p class="lh-sm text-black large text-uppercase"><?= __("Мы строим прозрачные отношения с клиентами и партнерами, основываясь на честности и искренности");?></p>
