            ...
            <div class="row gx-xl-5 gx-lg-4 gx-0 mb-xl-5 mb-4 gy-3">
              ...
              <div class="col-lg-4">
                <div>
                  ...
                  <p class="lh-sm text-gray small"><?= __("Taklog Industries, LLC предлагает надежные и эффективные автомобильные перевозки, охватывающие основные маршруты Европы, Центральной Азии, Турции и СНГ. Наш автопарк включает более 40 современных транспортных средств - рефрижераторы, платформы lowbed для негабаритных грузов и автомобили, сертифицированные по стандарту ADR для перевозки опасных грузов, соответствующие, в том числе,  экологическим стандартам EURO-5 и EURO-6.

Наши клиенты получают доступ к широкой сети авиаперевозчиков и оптимизированным маршрутам, что позволяет максимально эффективно планировать логистику. Мы берём на себя оформление всей документации, таможенное сопровождение и координацию грузов в аэропортах.
"); ?></p>
