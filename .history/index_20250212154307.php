  ...
  <section class="py-5 bg-ocean rounded-4 index-services position-relative wow fadeInUp">
    <div class="container-fluid common-container">
      ...
      <div class="row gx-lg-4 gx-0 gy-2 mb-lg-3">
        <div class="col-lg-8">
          <span class="text-uppercase text-corp font-gilda medium-quote lh-sm d-block mb-2 subtitle"><?= __("транспорт для всех задач"); ?></span>
        </div>
        <div class="col-lg-4">
      ...
      <div class="slider-services py-4">
        ...
        <div class="d-flex flex-column justify-content-between h-100">
          <div class="text-corp">
            ...
            <p class="small lh-sm"><?= __("Когда время имеет значение, мы обеспечим быструю и надежную доставку вашего груза, доставляя его авиационным транспортом. Гарантируем точное соблюдение сроков, безопасность груза и полное логистическое сопровождение
"); ?></p>
          </div>
          <div class="">
            <a class="btn btn-outline-dark rounded-1 text-start w-100" href="/services"><?= __("Узнать больше"); ?><i class="bi bi-arrow-down-right float-end"></i></a>
