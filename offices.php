...
<html>
  ...
  <body>
    ...
    <!-- Banner -->
    <section class="offices-banner position-relative py-5 wow fadeInUp">
      <div class="container-fluid common-container h-100">
        <div class="text-white box d-flex flex-column justify-content-end align-items-start h-100">
          <h1 class="text-uppercase"><?= __("Офисы"); ?></h1>
          <p class="lh-sm small mb-lg-4 with-arrow position-relative"><?= __("TAKLOG имеет свои офисы во многих странах. Штаб-квартира нашей компании находится в Хоф / Верхняя Франкония. Наши офисы в таких странах как Узбекистан, Германия, Турция. Наши локации по всему миру можно посмотреть здесь:"); ?></p>
